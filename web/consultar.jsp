<%-- 
    Document   : consultar
    Created on : 2 de mai de 2019, 01:31:06
    Author     : ademar
--%>
...
<table width="402" height="35" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000099" background="../IMAGENES/barramorada.jpg" bgcolor="#FFFFFF">
      <tr bgcolor="#0000CC">
        <td align="center"><FONT color="#FFFFFF" SIZE=4 >CONSULTAS DE USUÁRIOS - BANCO DE DADOS</FONT></td>
      </tr>
</table>
<table width="400" border="1" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" bordercolor="#000099">
  <tr >
    ...
    <td width="254" align="center" bgcolor="#999999"><FONT color="#FFFFFF" ><strong>NOME</strong></FONT></td>
  </tr>
<%
